...
namespace benchmarks
{
    ...
    public class Program
    {
        ...
        {
        var folderLocation = $"{new FileInfo(Assembly.GetExecutingAssembly().Location).Directory}";
        foreach (string path in Directory.EnumerateFiles(folderLocation, "*.*", SearchOption.AllDirectories))
        {
        }
        }
    }
